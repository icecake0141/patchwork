...
Welcome — this directory contains the project documentation.
...
Link to main README for setup and validation commands.

## 日本語訳

このディレクトリには、本プロジェクトのドキュメントが含まれています。
...
セットアップ手順と検証コマンドはメイン README を参照してください。
