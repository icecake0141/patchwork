...
GitHub Actions workflow is defined in `.github/workflows/ci.yml` and runs `black --check .`, `ruff check .`, `mypy .`, `pytest -q`, and `pre-commit run --all-files` on Python 3.10 and 3.11.
